...
| [`jamforelse/`](jamforelse/) | Prompter, jämförelse mellan tre skript, testsvit och testresultat |

I [`jamforelse/`](jamforelse/) finns också `nyanvandare.sh` (Claude), `gemini_nyanvandare.sh` (Gemini), rollback-skriptet och en fullständig genomgång inför muntlig validering. Börja med [`jamforelse/README.md`](jamforelse/README.md).
